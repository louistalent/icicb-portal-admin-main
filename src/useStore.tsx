...
export const D = (time:number) => (time ? new Date(time * 1000).toDateString() : '')
export const TimeToString = (time:number, hasTime?:boolean) => {
    ...
    return y+'-'+dt+' ' + (hasTime ? tt : '')
}
export const TF = (time:number) => ( new Date(time*1000).toLocaleString() )
